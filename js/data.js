/* ═══════════════════════════════════════════════════════
   PM English — data.js
   Static scenario data (no fetch needed — GitHub Pages safe)
   To add a scenario: copy one SCENARIOS entry and edit it.
   ═══════════════════════════════════════════════════════ */
...
/* ── SCENARIOS ──
   Each entry maps directly to a scenarios/*.md file.
   Fields: id, groupId, title, sub, icon, iconBg,
           level, vocab[], tip (HTML ok), lines[]
   Line fields: speaker, role (pm|dev|client), text
   ───────────────────────────────────────────────── */
const SCENARIOS = [
...
/* ── Normalize: add muted:false to all lines, derive level colors ── */
const LEVEL_STYLES = {
...
/* ── loadScenarios() — kept async so init() code is unchanged ── */
